...
def build2(image_set, args):
    root = Path(args.coco_path)
    PATHS = {
        "train": (root / "train_images", root / "annotations" / 'voc_trainval_coco.json'),
        "train_reg": (root / "train_images", root / "annotations" / 'voc_trainval_coco.json'),
        "val": (root / "test_images", root / "annotations" / 'voc_test_coco.json'),
        "eval_debug": (root / "test_images", root / "annotations" / 'voc_test_coco.json'),
        "test": (root / "test_images", root / "annotations" / 'voc_test_coco.json' ),
    }
...
def build3(image_set, args):
    root = Path(args.coco_path)
    PATHS = {
        "train": (root / "traindata", root / "annotation" / 'coco_annotations_train.json'),
        "train_reg": (root / "traindata", root / "annotation" / 'coco_annotations_train.json'),
        "val": (root / "evaldata", root / "annotation" / 'coco_annotations_test.json'),
        "eval_debug": (root / "evaldata", root / "annotation" / 'coco_annotations_test.json'),
        "test": (root / "evaldata", root / "annotation" / 'coco_annotations_test.json' ),
    }
...
def build4(image_set, args):
    root = Path(args.coco_path)
    PATHS = {
        "train": (root / "chickenimage", root / "annotation" / 'merged_dataset.json'),
        "train_reg": (root / "chickenimage", root / "annotation" / 'merged_dataset.json'),
        "val": (root / "evaldata2", root / "annotation" / 'eval2.json'),
        "eval_debug": (root / "evaldata2", root / "annotation" / 'eval2.json'),
        "test": (root / "evaldata2", root / "annotation" / 'eval2.json' ),
    }
