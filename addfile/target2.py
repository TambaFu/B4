...
image_path = "bird/traindata/085.png"  # 画像ファイルのパス

# アノテーションデータをロード
with open(annotation_path, "r") as f:
    coco_data = json.load(f)

# 画像IDを取得 (file_name が "062.png" の image_id を探す)
image_id = None
for image in coco_data["images"]:
    if image["file_name"] == "085.png":
        image_id = image["id"]
        break

if image_id is None:
    raise ValueError("指定された画像 '062.png' の情報が見つかりません。")
...
# タイトルと表示
ax.set_title("Bounding Boxes with Labels on 062.png")
plt.axis("off")
plt.show()
